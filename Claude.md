...
- There are several kinds of documentation that should be kept up-to-date.
  ...
  - Roadmap markdown docs in `/design`: describe future work in manageable chunks. Each file is a work item. Each work item can have dependency links to other work item files. Keep work items as orthogonal as possible. Update these after each PR is code-complete and tested.
