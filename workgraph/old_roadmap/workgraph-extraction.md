...
([old_design/scheduler-library.md](../../old_design/scheduler-library.md) marks
...
- The consumer-API identifiers are settled:
  [old_design/scheduler-library.md](../../old_design/scheduler-library.md) carries
...
- [Rebuilding workgraph over cellgraph](adopt-cellgraph.md) — the published
