...
What `workgraph` adds on top of the [cellgraph](../../cellgraph/design/cellgraph.md)
...
[scheduler-library.md](../../old_design/scheduler-library.md) owns the embedder-facing
