...
//! ([old_design/witnessed-memory.md](../old_design/witnessed-memory.md)). [`witnessed::Witnessed`] bundles
...
//!
//! Reach evidence splits by ownership ([old_design/reach.md](../old_design/reach.md)):
...
//! ([old_design/sectioned-reach.md](../old_design/sectioned-reach.md)).
//!
...
//! ([old_design/dag-scheduler.md](../old_design/dag-scheduler.md)). [`scheduler::Scheduler`] is generic
