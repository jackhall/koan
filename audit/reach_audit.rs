...
//! [reach.md](../workgraph/old_design/reach.md), whose
//! [§ Debug audits](../workgraph/old_design/reach.md#debug-audits) covers the library-side pin-ring
...
fn collect_substrate_addresses<C>(
    ...
    for cell in substrate.cells() {
        ...
        match cell {
            ...
            Held::Type(_) | Held::UnresolvedType(_) | Held::Name(_) | Held::RecordType(_) => {}
        }
    }
}
