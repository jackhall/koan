...
- [Source the free-identifier walk's last two rules](../roadmap/old_refactor/free-identifier-walk-sourcing.md)
...
- [Callable copy tuning](../roadmap/old_foundation/callable-copy-tuning.md) — the
  ...
  for α.
- [Module scope consolidation](../roadmap/old_foundation/module-scope-consolidation.md)
...
- [Callable cells in copied containers](../roadmap/old_foundation/callable-cells-in-copied-containers.md)
  ...
  never even offered.
- [A flattened dispatch registration pins its defining frame](../roadmap/old_foundation/flattened-registration-pins-its-frame.md)
