...
Terms this doc and the [untyped_arena](../roadmap/old_untyped_arena/README.md)
roadmap items use with fixed meanings. The machinery behind them is owned by
[workgraph/old_design/witnessed-memory.md](../workgraph/old_design/witnessed-memory.md)
...
- **Reach** — the set of foreign regions a value's borrows can point into.
  **Minting** a reach produces a paired non-owning description (into the
  ...
  ([workgraph/old_design/sectioned-reach.md](../workgraph/old_design/sectioned-reach.md)).
...
- **Memos are stored facts.** Contains-borrows ⇔ any run's description
  ...
  ([sectioned-reach.md § Weight](../workgraph/old_design/sectioned-reach.md#weight)),
  so no container door re-folds over cells to price one. Borrows-home is exact because of the **run-level self rule**
  at the alloc door
  ([sectioned-reach.md § The alloc door](../workgraph/old_design/sectioned-reach.md#the-alloc-door)):
...
- **`copy_cost`** — memoized on every substrate at construction, as the sectioned
  storage's own weight ([sectioned-reach.md § Weight](../workgraph/old_design/sectioned-reach.md#weight)):
...
([reach.md § The pin bundle](../workgraph/old_design/reach.md#the-pin-bundle)) — an
...
- **Verification.** The Miri audit slate ([observe/miri_slate_pending_rewrite.md](../observe/miri_slate_pending_rewrite.md))
...
The [untyped_arena](../roadmap/old_untyped_arena/README.md) project carries what is
left:

- [Region evacuation at frame death](../roadmap/old_untyped_arena/region-evacuation.md)
