...
- [witness-hosting.md](witness-hosting.md) — Koan's reach *policy*: the
  ...
  [workgraph/old_design/reach.md](../workgraph/old_design/reach.md).
...
- [effects.md](effects.md) — the in-language monadic side-effects
  ...
  Tracked in
  [roadmap/old_foundation/monadic-side-effects.md](../roadmap/old_foundation/monadic-side-effects.md).
- [compilation.md](compilation.md) — the compilation model: build-time
  ...
  Tracked in
  [roadmap/old_editor_tooling/two-phase-execution.md](../roadmap/old_editor_tooling/two-phase-execution.md).
