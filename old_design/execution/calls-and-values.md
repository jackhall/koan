...
[`Carried`](../../src/machine/model/values/cell.rs); a type rides the
...
- `MODULE` and `SIG` bodies enter through the dispatch harness's `InScope`
  ...
  `KExpression::is_statement_block` is the single
...
- **Inference and search as scheduler work**
  ...
  [stage 5](../../roadmap/old_predicate_typing/modular-implicits.md) layers
  implicit search.
