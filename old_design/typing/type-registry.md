...
- **Registry** — the single owner of all type content in a run. One half of the run
  frame's owned `RunRegistries` bundle ([`run_frame.rs`](../../src/machine/execute/run_frame.rs)),
...
[bump door](../../workgraph/old_design/witnessed-memory.md#the-bump-allocator), and the node table is a hash map built over the
...
- [Cross-registry type-content transfer](../../roadmap/old_type_language/cross-registry-type-content-transfer.md)
