...
- [Stage 4 — Property testing and axioms](../../roadmap/old_predicate_typing/axioms-and-generators.md)
  ...
  ([old_design/effects.md](../effects.md)), so this stage requires
  [Monadic side effects](../../roadmap/old_foundation/monadic-side-effects.md). Independent
...
- [Stage 6 — Equivalence-checked coherence](../../roadmap/old_predicate_typing/equivalence-checking.md)
  — cross-implicit equivalence testing using the stage-4 engine. The
  coherence story.
- [Stage 7 — Syntax tuning and witness types](../../roadmap/old_predicate_typing/syntax-tuning.md)
...
- [Standard library](../../roadmap/old_libraries/standard-library.md) — collections built
...
- [Stage 5 — Modular implicits](../../roadmap/old_predicate_typing/modular-implicits.md)
  ...
  [stage-4 engine](../../roadmap/old_predicate_typing/axioms-and-generators.md).
- [Two-phase execution](../../roadmap/old_editor_tooling/two-phase-execution.md)
