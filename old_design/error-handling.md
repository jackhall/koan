...
tracked under
[modular implicits](../roadmap/old_predicate_typing/modular-implicits.md).
...
- **`Result` combinators** — `map`, `bind`, `unwrap_or`, etc.; Koan source
  ...
  [standard library](../roadmap/old_libraries/standard-library.md). The `Result`
...
- **Continue-on-error** — top-level continuation past a single failed
  ...
  [continue-on-error for the REPL and batch mode](../roadmap/old_editor_tooling/continue-on-error.md).
