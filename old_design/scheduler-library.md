...
[witnessed-memory.md](../workgraph/old_design/witnessed-memory.md) owns the
witnessed substrate mechanics and
[reach.md](../workgraph/old_design/reach.md) the reach representation;
...
- **Reach set** — an **opaque library pair** naming the set of regions a
  ...
  assemble one by hand. [reach.md](../workgraph/old_design/reach.md) owns the
...
- **Edge** — one consumer→producer relationship, the sole boundary currency
  ...
  ([workgraph/old_design/dag-scheduler.md § Edges and the boundary](../workgraph/old_design/dag-scheduler.md#edges-and-the-boundary)).
...
- **Delivery envelope** — *(working name `Delivered`)* a walking terminal's
  ...
  **reference-only** (pins nothing); the envelope's bundle is what keeps its
  ...
  ([workgraph/old_design/dag-scheduler.md § Delivery at finalize](../workgraph/old_design/dag-scheduler.md#delivery-at-finalize)).
...
([dag-scheduler.md § The drain protocol](../workgraph/old_design/dag-scheduler.md#the-drain-protocol)).
...
[witnessed-memory.md](../workgraph/old_design/witnessed-memory.md) — with the same carrier and
...
- [Publishing the workgraph crate](../workgraph/old_roadmap/workgraph-extraction.md)
