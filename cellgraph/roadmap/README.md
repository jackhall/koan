...
changes its measurement harness gates; what is open is the doors koan's
`memory` module needs, and the gaps recorded below, which nothing is
scheduled against. `workgraph`'s
...
- [Cell brand and writer doors](cell-brand-and-writer.md)
