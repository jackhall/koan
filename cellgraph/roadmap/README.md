...
the mechanisms koan's scheduler elects and the gaps recorded below, which
nothing is scheduled against. `workgraph`'s
...
- [Shared regions, a scratch habitat and region recycling](shared-regions.md)
