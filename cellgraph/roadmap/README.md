...
atomically, and prices what that retention costs; what is scheduled here is the
shape of what it exports and the door a value crosses steps through. The gaps
that are known but
unplanned are recorded below. `workgraph`'s adoption of the crate is on the
scheduler's own roadmap
...
- [Resident carriers and the crossing price](resident-carriers.md)
