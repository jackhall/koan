...
the item below, which koan's scheduler is scheduled against, and the gaps
recorded after it, which nothing is. `workgraph`'s
...
- [Delivery into a parked cell's scratch](scratch-delivery.md)
