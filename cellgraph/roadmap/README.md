...
atomically, and prices what that retention costs, so nothing is scheduled
against it here today; the gaps that are known but unplanned are recorded
below. `workgraph`'s adoption of the crate is on the scheduler's own roadmap
