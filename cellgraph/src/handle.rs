...
/// A handle to either kind of cell: a place — a slab slot or a tree-pool index — paired with the
/// generation its occupant held when the handle was minted. Exactly the two things a step can name
/// as a placement destination, a parent, or the cell it is running in.
///
/// A place and a generation is the whole of what the two kinds share, and it is the line the name
...
/// at all. "Root" is a role rather than a kind — any slab cell becomes one the moment it parents a
