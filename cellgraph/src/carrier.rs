//! The two carrier states that carry a step lifetime. A value with reach passes through three, in
//! order of liveness: [`Dormant`](crate::Dormant), at rest and free of every step brand, which lives in
