...
| `<verb:Identifier> (<args>)`             | Call a function, tagged-union type, or struct type bound under `<verb>`.                        | [scheduler/dispatch.rs](src/machine/execute/scheduler/dispatch.rs) (`fast_lane_function_value_call`) |
