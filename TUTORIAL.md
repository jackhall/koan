...
| `<verb:Type> (<args>)`                   | Construct a tagged or struct value, e.g. `Maybe (some 42)` or `Point {x = 3, y = 4}`.             | [dispatch/single_poll.rs](src/machine/execute/dispatch/single_poll.rs) (`TypeCall` fast lane) |
