...
([dag-scheduler.md](../../workgraph/old_design/dag-scheduler.md)). A koan
...
- The pin ring between a persistent producer frame and its consumer is
  ...
  audit ([reach.md § Debug audits](../../workgraph/old_design/reach.md#debug-audits)).

**Directions.**

- *Node lifecycle — decided.* A yield is a **delivering park**: the parked
  node delivers a value on the way down
  ([continuations.md](../../old_design/execution/continuations.md)), and waits in
...
- *Element crossing — decided* per
  [old_design/destination-homed-construction.md](../../old_design/destination-homed-construction.md):
