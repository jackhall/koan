...
([name-placeholders.md](../../old_design/execution/name-placeholders.md)). Two consequences sit in the
code today:
...
- *How co-declared definitions see each other — decided.* Through a declaration window shaped as
  [one-declaration-window.md](../old_refactor/one-declaration-window.md) settles it for types: a block's
...
- [One declaration-window representation](../old_refactor/one-declaration-window.md) — the single
