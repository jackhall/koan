...
[old_design/effects.md](../../old_design/effects.md) specifies the `Monad` signature, and both halves
...
([functors.md § Higher-kinded type slots](../../old_design/typing/functors.md#higher-kinded-type-slots));
...
([modules.md § Keyworded members](../../old_design/typing/modules.md#keyworded-members)). No Koan
...
- *Quantifying a member over the element type — decided.* `pure` and `bind` are **quantified
  ...
  ([modules.md § Keyworded members](../../old_design/typing/modules.md#keyworded-members)); this item
...
- *Purity classification — open.* Either derive the verdict on demand by reading the
  ...
  ([functors.md § Generativity](../../old_design/typing/functors.md#generativity)).
...
([modules.md § Keyworded members](../../old_design/typing/modules.md#keyworded-members)) and the
`TYPE (Type AS Wrap)` constructor slot.

**Unblocks:**

- [Standard library](../old_libraries/standard-library.md) — the standard effect modules ship as
  stdlib entries.
- [Module system stage 4 — Property testing and axioms](../old_predicate_typing/axioms-and-generators.md)
