...
- *Digest walks — open.* Whether `node_digest` and `canonical_type_digest` join the combinator or
  ...
  ([type-identity.md](../../old_design/typing/type-identity.md)), so a derived walk has to keep the tag
...
([modules.md § Keyworded members](../../old_design/typing/modules.md#keyworded-members)) is one more
