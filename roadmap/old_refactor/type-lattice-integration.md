...
Wire the core of [type-lattice.md](../../old_design/typing/type-lattice.md) into the machine, re-home
...
- `RunRegistries<'run>` hosts the core's `TypeRegistry<'run>`, constructed over the run root's
  ...
  allocator ([type-registry.md § Ownership and reclamation](../../old_design/typing/type-registry.md#ownership-and-reclamation)).
