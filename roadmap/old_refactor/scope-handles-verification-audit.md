...
[scope-handles.md](../../old_design/per-call-region/scope-handles.md) cites four
...
turns over the region, [tail-call-optimization.md](../../old_design/tail-call-optimization.md);
