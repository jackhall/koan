...
every call — ≈99 allocations per tail-loop step, ≈26 per operator dispatch, ≈66 per
...
- [Symbol-keyed dispatch buckets](symbol-keyed-dispatch-buckets.md)
- [Symbol-keyed nominal member names](symbol-keyed-nominal-members.md)
