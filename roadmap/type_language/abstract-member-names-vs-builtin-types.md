...
type member `Type` — [modules.md](../../design/typing/modules.md) (`MODULE int_ord = ((LET
...
deliberately module-own and never falls through to the builtin root, so `int_ord.Type` could
...
**Requires:** none — the collision is independent of how a module is *named* (a module's
snake_case name does not change what its *members* may be called).
