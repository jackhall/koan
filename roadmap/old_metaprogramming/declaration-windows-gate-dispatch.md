...
([old_design/typing/elaboration.md](../../old_design/typing/elaboration.md)) has no
...
- *Cross-window recursion — decided.* Refused. A splice cannot join the enclosing
  ...
  not announced
  ([old_design/typing/user-types.md](../../old_design/typing/user-types.md)). Keeping the
...
[Two-phase execution](../old_editor_tooling/two-phase-execution.md) has a soft
