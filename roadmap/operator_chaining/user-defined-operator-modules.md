...
their own module. The [operator-chain reducer](../../design/expressions-and-parsing.md) reduces a recognized
...
- *Binder lowering — decided.* An `OP` writes two things: its body into the
  ...
  [operator-chain reducer](../../design/expressions-and-parsing.md) walks. That registry entry — not a
