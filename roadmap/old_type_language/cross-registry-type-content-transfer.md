...
- *Cross-thread (concurrent), latent until concurrency ships.* Each future worker thread
  ...
  ([old_design/typing/type-registry.md § Concurrency](../../old_design/typing/type-registry.md)),
...
- *Transfer mechanism — open.* Two candidates from
  [old_design/typing/type-registry.md](../../old_design/typing/type-registry.md): copy the value's
