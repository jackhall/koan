...
- A type constructor carrying a witness as a module-kind slot (see
  [old_design/typing/functors.md](../../old_design/typing/functors.md#type-expressions-and-constraints))
...
- *Witness type encoding — decided per [old_design/typing/functors.md § Type expressions and constraints](../../old_design/typing/functors.md#type-expressions-and-constraints).*
