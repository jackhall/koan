...
- `head(xs)` and `sort(xs)` resolve through the same implicit-resolution
  ...
  ([old_design/typing/generics.md](../../old_design/typing/generics.md)) reads the
...
- A function over "anything that forms a group" is written with a
  ...
  the [`OP` / `GROUP` surface](../../old_design/operators.md) — and its
...
- *The parameter-side projection — decided.* The structural walk that
  ...
  ([modules.md § Keyworded members](../../old_design/typing/modules.md#keyworded-members)): it binds a
...
- *Resolution algorithm — decided per [old_design/typing/implicits.md § Resolution and coherence](../../old_design/typing/implicits.md#resolution-and-coherence-the-design-dials).*
...
- *Inference and search interleaving — decided per [old_design/typing/scheduler.md](../../old_design/typing/scheduler.md).*
...
- [Two-phase execution](../old_editor_tooling/two-phase-execution.md)
