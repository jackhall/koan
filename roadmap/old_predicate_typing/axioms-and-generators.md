...
- *Axiom syntax — decided per [old_design/typing/implicits.md § Axioms and property testing](../../old_design/typing/implicits.md#axioms-and-property-testing).*
...
- [Monadic side effects](../old_foundation/monadic-side-effects.md)
