...
([old_design/scheduler-library.md](../../old_design/scheduler-library.md)) forbids. That ruling
...
- Pool, eligibility gate, and reset live behind `NodeStore`; Koan-side code carries no
  ...
  ([old_design/scheduler-library.md](../../old_design/scheduler-library.md) boundary preserved).
...
- *Draw — decided.* The destination region must exist at decide time: argument adoption into a
  ...
  step's own ([old_design/tail-call-optimization.md § Soundness](../../old_design/tail-call-optimization.md#soundness),
