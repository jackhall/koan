...
- [Eliminating the workgraph escape hatch](scheduler_library/escape-hatch-elimination.md)
- [Fold-closure capture provenance](scheduler_library/fold-closure-provenance.md)
- [Region debug audits](scheduler_library/region-debug-audits.md)
- [Scheduler-owned lifetime tokens](scheduler_library/scheduler-lifetime-tokens.md)
- [Witness-derived binding](scheduler_library/witness-derived-binding.md)
