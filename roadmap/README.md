...
- [Checked-tier confinement to identity-preserving stores](compile_safety/checked-tier-confinement.md)
- [Fold-closure capture provenance](compile_safety/fold-closure-provenance.md)
