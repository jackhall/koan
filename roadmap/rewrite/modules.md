...
**Problem.** The [module layer](../../src/module/README.md) holds the module
...
- A member read evaluates: `m.f`, and a name surfaced by `USING … SCOPE`, read
  the [member run](../../src/module/README.md#layout-order) the module holds
...
- A coerced function member runs: calling the
  [barrier](../../src/module/README.md#members-are-born-coerced) an opaque view
...
- *Where the doors live — decided.* In the
  [module layer](../../src/module/README.md). This item evaluates them and adds
  no door of its own.
