...
the path to running a program, and one memory-tier item adds the knot shape
that circular values and mutually recursive functions are born in. A fourth
item moves each kept module's design doc into the module as its `README.md`,
