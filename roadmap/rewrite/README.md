...
path to running a program: the scheduler cut down to a veneer over the cell
substrate; the top level that turns a koan program into work for the drain; dispatch over all of them; module programs and yielding iterators
...
- [The scheduler as a veneer](scheduler-veneer.md)
