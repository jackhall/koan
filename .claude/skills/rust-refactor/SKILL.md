...
- `cargo build` alone doesn't catch test regressions or new clippy issues introduced by a rewrite. Run the `verify-koan` skill before declaring the refactor done.
