...
- Update top-of-file and inline source comments as you go, per Claude.md. **Don't** touch `design/`, `roadmap/` (including its `README.md` index), `README.md`, or `TUTORIAL.md` — that's the doc-shepherd's job downstream.
