...
use crate::dispatch::{BodyResult, CombineFinish, Frame, KKey, KObject, NodeId, Scope, Serializable};
...
impl<'a> Scheduler<'a> {
    ...
    pub(in crate::execute) fn schedule_list_literal(
        &mut self,
    ...
    pub(in crate::execute) fn schedule_dict_literal(
        &mut self,
