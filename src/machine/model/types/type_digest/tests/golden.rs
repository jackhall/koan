...
/// The twelve leaf types. Each is a bare domain tag, so these are the most load-bearing pins in
...
fn leaf_digests_are_pinned() {
    ...
    assert_handle_pinned("Never", KType::NEVER, 0x59dd8c1f_71e395f4_77717ff5_a93c2600);
}
