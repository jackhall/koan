...
use crate::runtime::model::types::{KType, Parseable, SignatureElement, Specificity};
...
/// they go through the [`call_by_name`](crate::runtime::builtins::call_by_name) builtin,
...
mod tests {
    ...
    fn dispatch_errors_on_ambiguous_overlap() {
        ...
        match result {
            Err(e) => assert!(
                matches!(e.kind, crate::runtime::machine::core::KErrorKind::AmbiguousDispatch { .. }),
    ...
    fn shape_pick_type_token_in_typeexprref_slot_returns_ref_name_indices() {
        ...
        let expr = KExpression {
            parts: vec![
                ExpressionPart::Keyword("OP".into()),
                ExpressionPart::Type(crate::ast::TypeExpr::leaf("IntOrd".into())),
            ],
        };
    ...
    fn shape_pick_type_token_in_any_slot_returns_wrap_indices() {
        ...
        let expr = KExpression {
            parts: vec![
                ExpressionPart::Keyword("OP".into()),
                ExpressionPart::Type(crate::ast::TypeExpr::leaf("Number".into())),
            ],
        };
