...
the closure's scope lives in — can never close a region↔value back-edge. The three named safe
wrappers (`alloc_function`, `alloc_scope`, `alloc_module`) each route the single
