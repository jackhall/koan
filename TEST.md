...
**Singleton transmutes** ([src/runtime/machine/core/arena.rs](src/machine/core/arena.rs)) — the `'static`→`'a`
...
**`CallArena` lifetime erasure** ([src/runtime/machine/core/arena.rs](src/machine/core/arena.rs)) — the
...
**`RuntimeArena` interior mutation under live borrows** ([src/runtime/machine/core/arena.rs](src/machine/core/arena.rs)).

- `runtime_arena_alloc_while_prior_ref_live`

**Cycle gate** ([src/runtime/machine/core/arena.rs](src/machine/core/arena.rs)) — `alloc_object` redirects
...
**Closure escape and TCO replace** ([src/runtime/builtins/call_by_name.rs](src/builtins/call_by_name.rs)) — a closure
...
**`Scope::add` re-entry** ([src/runtime/machine/core/scope.rs](src/machine/core/scope.rs)) — adding a binding while
...
**MATCH on `Tagged` recursion** ([src/runtime/builtins/match_case.rs](src/builtins/match_case.rs)) — the
...
**KFuture anchor decision** ([src/runtime/machine/execute/lift.rs](src/machine/execute/lift.rs)) — the targeted anchor: a KFuture
...
**Per-call arena reclamation** ([src/runtime/builtins/fn_def.rs](src/builtins/fn_def.rs)) — repeated user-fn
...
**Type-op dispatch through per-call arena** ([src/runtime/builtins/type_ops.rs](src/builtins/type_ops.rs)) — `MODULE_TYPE_OF`
...
**Module / Signature lifetime erasure** ([src/runtime/model/values/module.rs](src/machine/model/values/module.rs)) — `Module`
...
**MODULE body Combine continuation** ([src/runtime/builtins/module_def.rs](src/builtins/module_def.rs)) — the
...
**Dispatch-time placeholder parking** ([src/runtime/machine/execute/scheduler/dispatch.rs](src/machine/execute/scheduler/dispatch.rs)) — the bare-Identifier
